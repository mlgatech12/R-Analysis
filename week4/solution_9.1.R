...
# In this case, we are told to just use the first few principal components.
# We decide to use 4 here for illustration for the rest of the solution code.
...
originalAlpha <- alphas%*%1/sapply(data[,1:15],sd)
originalAlpha
originalAlpha <- alphas/pca$scale
